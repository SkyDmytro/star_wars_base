...
import { getInitialEdges, getInitialNodes } from "./functions";
...
const mockStarships: StarShipType[] = [
  {
    id: 2,
    name: "CR90 corvette",
    model: "CR90 corvette",
...
describe("getInitialNodes", () => {
  test("return correct values", () => {
    expect(
      getInitialNodes(mockCharacter, mockFilms, mockStarships)
    ).toStrictEqual(mockInitialNodes);
  });
});

describe("getInitialEdges", () => {
  it("should create initial edges correctly", () => {
